...
per=mm&abs(chromtoty)<2.5&abs(chromtotx)<2.5;
...
% clb=colorbar;
% colormap(jet);
% ylabel(clb,'\epsilon_x','FontSize',19)
% set(gca,'FontSize',17)
% box on
% axis('tight')
% set(gcf,'color','w');
...
figure;
scatter((mux(mm))/360,(muy(mm))/360,25,chromtotx(mm),'filled','s');
xlabel('\mu_x [2\pi]','FontSize',17)
ylabel('\mu_y [2\pi]','FontSize',17)
clb=colorbar;
colormap(flipud(jet));
...
figure;
scatter((mux(mm))/360,(muy(mm))/360,25,chromtoty(mm),'filled','s');
xlabel('\mu_x [2\pi]','FontSize',17)
ylabel('\mu_y [2\pi]','FontSize',17)
clb=colorbar;
colormap(flipud(jet));
...
clb=colorbar;
colormap(jet);
ylabel(clb,'\mu_y','FontSize',19)
%%
figure;
scatter(betacd,betaycd,20,DetFact,'filled','s');
xlabel('\mu_x [2\pi]','FontSize',17)
ylabel('\mu_y [2\pi]','FontSize',17)
clb=colorbar;
colormap(jet);
...
hold all;
scatter(f1(mm),f2(mm),25,DetFact(mm),'filled','ok');
hold all;
scatter(f1(per),f2(per),25,DetFact(per),'filled','dm');
...
axis('tight')
hold all;
scatter(f1(mm&f1>0&f2>-10&f2<0),f2(mm&f1>0&f2>-10&f2<0),25,DetFact(mm&f1>0&f2>-10&f2<0),'filled','ok');
%%
%edw vgazw ta f1-f2 me tin er
figure
...
%%
figure;
scatter3(LL1(mm),LL2(mm),LL3(mm),25,chromtotx(mm),'filled','s');
xlabel('s_1 [m]','FontSize',17)
ylabel('s_2 [m]','FontSize',17)
zlabel('s_3 [m]','FontSize',17)
clb=colorbar;
...
%%
figure
scatter(LL1(mm),LL2(mm),25,chromtotx(mm),'filled','s');
xlabel('s_1 [m]','FontSize',17)
ylabel('s_2 [m]','FontSize',17)
clb=colorbar;
colormap(flipud(jet));
...
figure;
scatter3(LL1(mm),LL2(mm),LL3(mm),25,etacd(mm),'filled','s');
xlabel('s_1 [m]','FontSize',17)
ylabel('s_2 [m]','FontSize',17)
zlabel('s_3 [m]','FontSize',17)
clb=colorbar;
...
%%
figure;
scatter3(LL1(mm),LL2(mm),LL3(mm),25,chromtoty(mm),'filled','s');
xlabel('s_1 [m]','FontSize',17)
ylabel('s_2 [m]','FontSize',17)
zlabel('s_3 [m]','FontSize',17)
clb=colorbar;
...
%%
figure
scatter(LL1(mm),LL2(mm),25,chromtoty(mm),'filled','s');
xlabel('s_1 [m]','FontSize',17)
ylabel('s_2 [m]','FontSize',17)
clb=colorbar;
colormap(flipud(jet));
